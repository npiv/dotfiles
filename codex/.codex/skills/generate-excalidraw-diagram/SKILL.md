...
description: Generate diagrams as .excalidraw files. Use when the user asks to create excalidraw diagrams
---
...
2. Come up with a high level idea for what the diagram should look like
2. Identify the main components in the diagrams
